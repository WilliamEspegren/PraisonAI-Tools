...
class SpiderScrapeToolSchema(BaseModel):
	"""Input for SpiderScrapeTool."""
...
class SpiderScrapeTool(BaseTool):
	name: str = "Scrape the web"
	description: str = "Tool to scrape the web with a query"
	args_schema: Type[BaseModel] = SpiderScrapeToolSchema
